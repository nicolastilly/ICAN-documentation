...
Il faut distinguer **deux solutions** pour prototyper vos projets : 

- La vidéo qui va présenter principalement des animations. Cette solution est passive, le format finale étant une vidéo à regarder.
- Des solutions plus interactives avec Figma par exemple, mais cela peut être limité/trop simple dans les interactions et animations.
