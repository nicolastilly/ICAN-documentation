...
- [Manipuler/zoom objet 3D dans une page Web](https://model-viewer-tree.glitch.me/)  - voir le [Code du projet](https://glitch.com/edit/#!/model-viewer-tree)

![](../images/capture-loupe.png)
![](../images/capture-model-viewer.png)
